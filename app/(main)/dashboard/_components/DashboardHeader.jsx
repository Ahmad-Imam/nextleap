      ...
      <div className="grid gap-4 md:gap-6 lg:gap-10 md:grid-cols-2 lg:grid-cols-4 ">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm md:text-lg lg:text-xl font-lg">
              Created Jobs
            </CardTitle>
            <BriefcaseIcon className="h-4 w-4 md:h-6 md:w-6 text-muted-foreground" />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <MailIcon className="h-4 w-4 md:h-6 md:w-6 text-muted-foreground" />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CalendarIcon className="h-4 w-4 md:h-6 md:w-6 text-muted-foreground" />
          </CardHeader>
          <CardContent>
